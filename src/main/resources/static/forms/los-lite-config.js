...
// login.js (POST /auth/login) dan dynamic-form.js (submit ke endpoint bisnis LOS-LITE,
// mis. POST /loan-applications lewat schema.button.path) - base URL cuma ditulis SEKALI
// di sini, bukan dobel-tulis di dua file itu.
//
